...
*/
const BotName = '👾JB RIZKY👾'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/mr6214076'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6282179822961'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @mr6214076`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @mr6214076`)
})
...
conn.sendMessage(id, 'Owner rizky https://wa.me/6282179822961' ,MessageType.text);
}
else if (text == 'Aris'){
